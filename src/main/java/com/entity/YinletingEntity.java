 ...
 */
@TableName("yinleting")
public class YinletingEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YinletingEntity() {
		
	}
	
	public YinletingEntity(T t) {
		try {
	...
	private String yinletingmingcheng;
	 ...
	 * 设置：音乐厅名称
	 */
	public void setYinletingmingcheng(String yinletingmingcheng) {
		this.yinletingmingcheng = yinletingmingcheng;
	}
	/**
	 * 获取：音乐厅名称
	 */
	public String getYinletingmingcheng() {
		return yinletingmingcheng;
	}
	/**
	 * 设置：座位数
	 */
